...
```
"react-native-notifications": "https://github.com/beda-software/react-native-notifications/releases/download/3.4.2.4-notification-local/react-native-notifications-3.4.2.4-notification-local.tgz"
```
